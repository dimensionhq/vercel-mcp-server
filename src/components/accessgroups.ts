...
export function registerAccessGroupTools(
	server: McpServer,
	accessToken: string,
) {
	...
	// 		const url = new URL(
	// 			`${BASE_URL}/v1/access-groups/${accessGroupIdOrName}/projects`,
	// 		);
	...
	// 				{
	// 					type: 'text',
	// 					text: `Access group project created:\n${JSON.stringify(
	// 						data,
	// 						null,
	// 						2,
	// 					)}`,
	...
	// 			)
	// 			.optional()
	// 			.describe('List of projects to add to the access group'),
	// 		membersToAdd: z
	// 			.array(z.string())
	// 			.optional()
	// 			.describe('List of members to add to the access group'),
	// 		...teamParams,
	// 	},
	...
	// 		const url = new URL(
	// 			`${BASE_URL}/v1/access-groups/${accessGroupIdOrName}/projects/${projectId}`,
	// 		);
	// 		if (teamId) url.searchParams.append('teamId', teamId);
	// 		if (slug) url.searchParams.append('slug', slug);
	// 		const response = await fetch(url.toString(), {
	...
	// 		return {
	// 			content: [
	// 				{ type: 'text', text: 'Access group project deleted successfully' },
	// 			],
	// 		};
	// 	},
	// );
	...
	// 				{
	// 					type: 'text',
	// 					text: `Access group project details:\n${JSON.stringify(
	// 						data,
	// 						null,
	// 						2,
	// 					)}`,
	...
	// 			)
	// 			.optional()
	// 			.describe('List of projects to update'),
	// 		membersToAdd: z
	// 			.array(z.string())
	// 			.optional()
	// 			.describe('List of members to add to the access group'),
	...
	// 			.array(z.string())
	// 			.optional()
	// 			.describe('List of members to remove from the access group'),
	// 		...teamParams,
	// 	},
	// 	async ({
	// 		idOrName,
	...
	// 				{
	// 					type: 'text',
	// 					text: `Access group project updated:\n${JSON.stringify(
	// 						data,
	// 						null,
	// 						2,
	// 					)}`,
