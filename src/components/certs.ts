...
export function registerCertTools(server: McpServer, accessToken: string) {
	// Get cert by id
	server.tool(
		'get_cert',
	...
	server.tool(
		...
		'Issue a new certificate',
		{
			cns: z
				.array(z.string())
				.describe('The common names the cert should be issued for'),
			teamId: z
				.string()
				.optional()
				.describe('The Team identifier to perform the request on behalf of'),
	...
	server.tool(
		...
		'Upload a certificate',
		{
			...
			skipValidation: z
				.boolean()
				.optional()
				.describe('Skip validation of the certificate'),
			teamId: z
				.string()
				.optional()
				.describe('The Team identifier to perform the request on behalf of'),
