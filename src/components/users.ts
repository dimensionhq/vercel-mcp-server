...
export function registerUserTools(server: McpServer, accessToken: string) {
	// Delete User Account
	// server.tool(
	// 	'delete_user',
	...
	// 					description: z
	// 						.string()
	// 						.describe('Detailed description of the reason'),
	// 				}),
	// 			)
	// 			.optional()
	// 			.describe(
	...
	// 			.optional()
	// 			.describe(
	// 				'Timestamp to only include items created since then (e.g. 2019-12-08T10:00:38.976Z)',
	// 			),
	// 		until: z
	// 			.string()
	// 			.optional()
	// 			.describe(
	// 				'Timestamp to only include items created until then (e.g. 2019-12-09T23:00:38.976Z)',
	// 			),
	// 		types: z
	// 			.string()
	// 			.optional()
	// 			.describe(
	// 				'Comma-delimited list of event types to filter the results by (e.g. login,team-member-join,domain-buy)',
	// 			),
	// 		userId: z
	// 			.string()
	// 			.optional()
	// 			.describe(
	// 				'When retrieving events for a Team, filter events by a specific member',
	// 			),
	// 		withPayload: z
	// 			.string()
	// 			.optional()
	// 			.describe(
	// 				'When set to true, includes the payload field for each event',
	// 			),
	// 		teamId: z
	// 			.string()
	// 			.optional()
