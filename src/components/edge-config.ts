...
export function registerEdgeConfigTools(
	server: McpServer,
	accessToken: string,
) {
	// Create Edge Config
	...
	server.tool(
		...
		async ({ edgeConfigId, label }) => {
			const response = await fetch(
				`${BASE_URL}/v1/edge-config/${edgeConfigId}/token`,
				{
					method: 'POST',
					headers: {
						'Content-Type': 'application/json',
	...
	server.tool(
		...
		async ({ edgeConfigId }) => {
			const response = await fetch(
				`${BASE_URL}/v1/edge-config/${edgeConfigId}`,
				{
					headers: {
						Authorization: `Bearer ${accessToken}`,
					},
	...
	server.tool(
		...
		async ({ edgeConfigId }) => {
			const response = await fetch(
				`${BASE_URL}/v1/edge-config/${edgeConfigId}/items`,
				{
					headers: {
						Authorization: `Bearer ${accessToken}`,
					},
	...
	server.tool(
		...
		async ({ edgeConfigId, itemKey }) => {
			const response = await fetch(
				`${BASE_URL}/v1/edge-config/${edgeConfigId}/item/${itemKey}`,
				{
					headers: {
						Authorization: `Bearer ${accessToken}`,
					},
	...
	server.tool(
		...
		async ({ edgeConfigId }) => {
			const response = await fetch(
				`${BASE_URL}/v1/edge-config/${edgeConfigId}/schema`,
				{
					headers: {
						Authorization: `Bearer ${accessToken}`,
					},
	...
	server.tool(
		...
		async ({ edgeConfigId }) => {
			const response = await fetch(
				`${BASE_URL}/v1/edge-config/${edgeConfigId}/tokens`,
				{
					headers: {
						Authorization: `Bearer ${accessToken}`,
					},
	...
	server.tool(
		...
		async ({ edgeConfigId, token }) => {
			const response = await fetch(
				`${BASE_URL}/v1/edge-config/${edgeConfigId}/token/${token}`,
				{
					headers: {
						Authorization: `Bearer ${accessToken}`,
					},
	...
	server.tool(
		...
		'List Edge Config Backups',
		{
			...
			limit: z
				...
				.max(50)
				.optional()
				.describe('Number of backups to return'),
		...
		async ({ edgeConfigId, ...params }) => {
			...
			const response = await fetch(
				`${BASE_URL}/v1/edge-config/${edgeConfigId}/backups?${queryParams}`,
				{
					headers: {
						Authorization: `Bearer ${accessToken}`,
					},
	...
	server.tool(
		...
		async ({ edgeConfigId, backupId }) => {
			const response = await fetch(
				`${BASE_URL}/v1/edge-config/${edgeConfigId}/backups/${backupId}`,
				{
					headers: {
						Authorization: `Bearer ${accessToken}`,
					},
