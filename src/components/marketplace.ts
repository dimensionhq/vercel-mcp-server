...
export function registerMarketplaceTools(
	...
	// 			.string()
	// 			.describe('Integration configuration ID'),
	// 		event: z
	// 			.object({
	...
	// 			`${BASE_URL}/v1/installations/${integrationConfigurationId}/events`,
	// 			{
	// 				method: 'POST',
	// 				headers: {
	...
	// 		const response = await fetch(
	// 			`${BASE_URL}/v1/installations/${integrationConfigurationId}/account`,
	// 			{
	// 				headers: {
	// 					Authorization: `Bearer ${accessToken}`,
	// 				},
	...
	// 		const response = await fetch(
	// 			`${BASE_URL}/v1/installations/${integrationConfigurationId}/billing/invoices/${invoiceId}`,
	// 			{
	// 				headers: {
	// 					Authorization: `Bearer ${accessToken}`,
	// 				},
	...
	// 		const response = await fetch(
	// 			`${BASE_URL}/v1/installations/${integrationConfigurationId}/member/${memberId}`,
	// 			{
	// 				headers: {
	// 					Authorization: `Bearer ${accessToken}`,
	// 				},
	...
	// 		const response = await fetch(
	// 			`${BASE_URL}/v1/installations/${integrationConfigurationId}/resources/${resourceId}`,
	// 			{
	// 				method: 'PUT',
	// 				headers: {
	// 					'Content-Type': 'application/json',
	...
	// 		const response = await fetch(
	// 			`${BASE_URL}/v1/installations/${integrationConfigurationId}/billing`,
	// 			{
	// 				method: 'POST',
	// 				headers: {
	// 					'Content-Type': 'application/json',
	...
	// 		return {
	// 			content: [
	// 				{ type: 'text', text: 'Billing data submitted successfully' },
	// 			],
	// 		};
	// 	},
	// );
	...
	// 	async ({ integrationConfigurationId, ...body }) => {
	// 		const response = await fetch(
	// 			`${BASE_URL}/v1/installations/${integrationConfigurationId}/billing/invoices`,
	// 			{
	// 				method: 'POST',
	// 				headers: {
	// 					'Content-Type': 'application/json',
	...
	// 		const response = await fetch(
	// 			`${BASE_URL}/v1/installations/${integrationConfigurationId}/resources/${resourceId}/secrets`,
	// 			{
	// 				method: 'PUT',
	// 				headers: {
	// 					'Content-Type': 'application/json',
	...
	// 		return {
	// 			content: [
	// 				{ type: 'text', text: 'Resource secrets updated successfully' },
	// 			],
	// 		};
	// 	},
	// );
	...
	// 	async ({ integrationConfigurationId, ...body }) => {
	// 		const response = await fetch(
	// 			`${BASE_URL}/v1/installations/${integrationConfigurationId}/billing/balance`,
	// 			{
	// 				method: 'POST',
	// 				headers: {
	// 					'Content-Type': 'application/json',
	...
	// 		return {
	// 			content: [
	// 				{ type: 'text', text: 'Balance data submitted successfully' },
	// 			],
	// 		};
	// 	},
	// );
	...
	// 		const response = await fetch(
	// 			`${BASE_URL}/v1/installations/${integrationConfigurationId}/billing/invoices/${invoiceId}/actions`,
	// 			{
	// 				method: 'POST',
	// 				headers: {
	// 					'Content-Type': 'application/json',
	...
	// 		return {
	// 			content: [
	// 				{ type: 'text', text: 'Invoice action completed successfully' },
	// 			],
	// 		};
	// 	},
	// );
