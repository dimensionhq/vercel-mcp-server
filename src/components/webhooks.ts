...
export function registerWebhookTools(server: McpServer, accessToken: string) {
	// // Create a webhook
	// server.tool(
	// 	'create_webhook',
	// 	'Creates a webhook',
	...
	// 			.string()
	// 			.optional()
	// 			.describe('Team ID to perform the request on behalf of'),
	// 		slug: z
	// 			.string()
	// 			.optional()
	...
	// 		throw new Error(
	// 			`Failed to delete webhook: ${response.status} - ${errorData}`,
	// 		);
	// 	},
	// );
	// // List webhooks
