...
export function registerDomainTools(server: McpServer, accessToken: string) {
	...
	// 			.optional()
	// 			.describe(
	// 				'When true, only include nameservers assigned directly to the domain',
	// 			),
	// 		teamId: z
	// 			.string()
	// 			.optional()
	...
	// 			.number()
	// 			.optional()
	// 			.describe('Maximum number of domains to list'),
	// 		since: z
	// 			.number()
	// 			.optional()
	// 			.describe('Get domains created after this timestamp'),
	// 		until: z
	// 			.number()
	// 			.optional()
	// 			.describe('Get domains created before this timestamp'),
	// 		teamId: z
	// 			.string()
	// 			.optional()
	// 			.describe('The Team identifier to perform the request on behalf of'),
	...
	// 			.number()
	// 			.optional()
	// 			.describe('The expected price for the purchase'),
	// 		renew: z
	// 			.boolean()
	// 			.optional()
	// 			.describe('Whether to auto-renew the domain'),
	...
	// 	{
	// 		method: z
	// 			.enum(['add', 'transfer-in'])
	// 			.describe('The domain operation to perform'),
	...
	// 				{
	// 					type: 'text',
	// 					text: `Domain registration result:\n${JSON.stringify(
	// 						data,
	// 						null,
	// 						2,
	// 					)}`,
