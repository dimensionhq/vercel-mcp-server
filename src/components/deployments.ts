	...
	server.tool(
		...
		'Create a new deployment with all required data',
		{
			...
			project: z
				.string()
				.optional()
				.describe('Target project identifier (overrides name)'),
			files: z
				.array(
					z.object({
						data: z.string(),
			...
			gitMetadata: z
				...
				.optional()
				.describe('Git metadata for the deployment'),
			gitSource: z
				.object({
					type: z.string(),
			...
			target: z
				.string()
				.optional()
				.describe('Deployment target (production, preview, staging)'),
			deploymentId: z
				.string()
				.optional()
				.describe('Existing deployment ID to redeploy'),
			meta: z
			...
			projectSettings: z
				...
				.optional()
				.describe('Project settings for the deployment'),
			forceNew: z
				.boolean()
				.optional()
				.describe('Force new deployment even if similar exists'),
			skipAutoDetectionConfirmation: z
				.boolean()
				.optional()
				.describe('Skip framework detection confirmation'),
			customEnvironmentSlugOrId: z
				.string()
				.optional()
				.describe('Custom environment to deploy to'),
			monorepoManager: z
				.string()
				.nullable()
				.optional()
				.describe('Monorepo manager being used'),
			withLatestCommit: z
				.boolean()
				.optional()
				.describe('Force latest commit when redeploying'),
			teamId: z
				.string()
				.optional()
				.describe('Team identifier to perform the request on behalf of'),
			slug: z
				.string()
				.optional()
				.describe('Team slug to perform the request on behalf of'),
		},
		async ({
			name,
			project,
	...
	server.tool(
		...
		'Get build logs and events for a deployment',
		{
			...
			since: z
				.number()
				.optional()
				.describe('Timestamp to start pulling logs from'),
	...
	server.tool(
		...
		'List deployments under the authenticated user or team',
		{
			...
			from: z
				.number()
				.optional()
				.describe('Get deployments created after this timestamp (deprecated)'),
			limit: z
				.number()
				.optional()
			...
			to: z
				.number()
				.optional()
				.describe('Get deployments created before this timestamp (deprecated)'),
			users: z
				.string()
				.optional()
