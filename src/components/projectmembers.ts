...
export function registerProjectMemberTools(
	server: McpServer,
	accessToken: string,
) {
	// Add Project Member
	server.tool(
		...
		'Adds a new member to a project',
		{
			...
			role: z
				...
				.describe('The project role of the member that will be added'),
			...teamParams,
		},
