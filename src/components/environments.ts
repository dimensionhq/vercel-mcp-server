...
export function registerEnvironmentTools(
	...
	// 			})
	// 			.optional()
	// 			.describe('Branch matching configuration'),
	// 		copyEnvVarsFrom: z
	// 			.string()
	// 			.optional()
	// 			.describe('Copy environment variables from this environment'),
	// 		teamId: z
	// 			.string()
	// 			.optional()
	...
	// 	}) => {
	// 		const url = new URL(
	// 			`${BASE_URL}/v9/projects/${idOrName}/custom-environments`,
	// 		);
	...
	// 		deleteUnassignedEnvVars: z
	// 			.boolean()
	// 			.optional()
	// 			.describe('Delete unassigned environment variables'),
	// 		teamId: z
	// 			.string()
	// 			.optional()
	// 			.describe('The Team identifier to perform the request on behalf of'),
	...
	// 		idOrName,
	// 		environmentSlugOrId,
	// 		deleteUnassignedEnvVars,
	// 		teamId,
	// 		teamSlug,
	// 	}) => {
	// 		const url = new URL(
	// 			`${BASE_URL}/v9/projects/${idOrName}/custom-environments/${environmentSlugOrId}`,
	// 		);
	// 		if (teamId) url.searchParams.append('teamId', teamId);
	// 		if (teamSlug) url.searchParams.append('slug', teamSlug);
	// 		const response = await fetch(url.toString(), {
	...
	// 			},
	// 			body: JSON.stringify({
	// 				deleteUnassignedEnvironmentVariables: deleteUnassignedEnvVars,
	// 			}),
	// 		});
	// 		const data = await handleResponse(response);
	// 		return {
	...
	// 			.max(256)
	// 			.optional()
	// 			.describe('New environment description'),
	// 		branchMatcher: z
	// 			.object({
	// 				type: z.enum(['equals']),
	// 				pattern: z.string(),
	...
	// 			.nullable()
	// 			.optional()
	// 			.describe('New branch matching configuration'),
	// 		teamId: z
	// 			.string()
	// 			.optional()
	// 			.describe('The Team identifier to perform the request on behalf of'),
