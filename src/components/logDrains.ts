...
export function registerLogDrainTools(server: McpServer, accessToken: string) {
	...
	// 		deliveryFormat: z
	// 			.enum(['json', 'ndjson'])
	// 			.describe('The delivery log format'),
	// 		url: z
	// 			.string()
	// 			.url()
	// 			.regex(/^(http|https)?:\/\//)
	// 			.describe('The log drain url'),
	// 		headers: z
	...
	// 			.min(1)
	// 			.max(50)
	// 			.describe('Project IDs to watch'),
	// 		sources: z
	// 			.array(
	// 				z.enum(['static', 'lambda', 'build', 'edge', 'external', 'firewall']),
	// 			)
	// 			.min(1)
	// 			.describe('Sources to watch'),
	// 		environments: z
	// 			.array(z.enum(['preview', 'production']))
	// 			.min(1)
	// 			.describe('Environments to watch'),
	...
	// 			.max(1)
	// 			.optional()
	// 			.describe('The sampling rate for this log drain'),
	...
	// 			.regex(/^[A-z0-9_ -]+$/)
	// 			.optional()
	// 			.describe('Secret to sign log drain notifications'),
	// 		deliveryFormat: z
	...
	// 			.string()
	// 			.url()
	// 			.regex(/^(https?|syslog\+tls|syslog):\/\//)
	// 			.describe('The url where you will receive logs'),
	// 		sources: z
	// 			.array(
	// 				z.enum(['static', 'lambda', 'build', 'edge', 'external', 'firewall']),
	// 			)
	...
	// 				{
	// 					type: 'text',
	// 					text: `Integration log drain created:\n${JSON.stringify(
	// 						data,
	// 						null,
	// 						2,
	// 					)}`,
	...
	// 		return {
	// 			content: [
	// 				{ type: 'text', text: 'Integration log drain deleted successfully' },
	// 			],
	// 		};
	// 	},
	// );
	...
	// 			.string()
	// 			.optional()
	// 			.describe('Filter by project ID or name'),
	// 		teamId: z
	// 			.string()
	// 			.optional()
	// 			.describe('The Team identifier to perform the request on behalf of'),
	...
	// 				{
	// 					type: 'text',
	// 					text: `Integration log drains list:\n${JSON.stringify(
	// 						data,
	// 						null,
	// 						2,
	// 					)}`,
