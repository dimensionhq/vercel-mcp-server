...
export async function register(
	...
	registerEdgeConfigTools(server, accessToken);
	registerSecretTools(server, accessToken);
	registerEnvironmentTools(server, accessToken);
	registerWebhookTools(server, accessToken);
	registerLogDrainTools(server, accessToken);
	registerSpeedInsightsTools(server, accessToken);
