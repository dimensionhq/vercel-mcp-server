...
export async function register(
	...
	registerTeamTools(server, accessToken);
	registerUserTools(server, accessToken);
	registerAuthTools(server, accessToken);
	registerAccessGroupTools(server, accessToken);
	registerSecurityTools(server, accessToken);
