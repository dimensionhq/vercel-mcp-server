...
export function registerResources(server: McpServer, accessToken: string) {
	// Project resource
	server.resource(
		'project',
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v9/projects/${variables.projectId}`,
				{
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v13/deployments/${variables.deploymentId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v9/projects/${variables.projectId}/env`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v5/domains/${variables.domain}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v1/webhooks/${variables.webhookId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v1/integrations/${variables.integrationId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		'project-member',
		new ResourceTemplate('project-members://{projectId}/{userId}', {
			list: undefined,
		}),
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v9/projects/${variables.projectId}/members/${variables.userId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v1/access-groups/${variables.groupId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v1/log-drains/${variables.drainId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v9/projects/${variables.projectId}/env/${variables.name}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v2/aliases/${variables.aliasId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		'artifact',
		new ResourceTemplate('artifacts://{projectId}/{artifactId}', {
			list: undefined,
		}),
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v8/artifacts/${variables.projectId}/${variables.artifactId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v5/now/certs/${variables.certId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v2/domains/${variables.domain}/records/${variables.recordId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v1/marketplace/integrations/${variables.integration}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v1/edge-config/${variables.configId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v1/speed-insights/${variables.projectId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v1/security/projects/${variables.projectId}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
	...
	server.resource(
		...
		async (uri, variables) => {
			const response = await fetch(
				`${BASE_URL}/v2/user/tokens/${variables.token}`,
				{
					headers: { Authorization: `Bearer ${accessToken}` },
				},
			);
